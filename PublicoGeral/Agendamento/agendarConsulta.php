...
<head>
    ...
    <meta name="description" content="COMP - Agendamento de Consulta">
    <link rel="stylesheet" href="../css/stylePadrao.css">
    <link rel="stylesheet" href="../css/styleForms.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <title>Clínica Médica COMP - Agendamento</title>
</head>
...
<body>
    ...
    <script>
        // Requisição AJAX para horarios-disponiveis.php
        // Remove do <select> de horários todas as opções que já estão ocupadas, faz isso pelo arquivo JSON gerado
        ...
        // Requisição AJAX para medicos-por-especialidade.php
        // Retorna apenas os médicos daquela especialidade, gerado pelo arquivo JSON
